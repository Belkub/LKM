...
**ЭТО ОБЯЗАТЕЛЬНЫЙ ШАГ**, иначе приложение будет показывать ошибку:
...
3. **ВАЖНО:** После добавления переменной обязательно перейдите на вкладку **Deployments**, выберите последний деплой и нажмите **Redeploy**. Без перезапуска сборки Vite не увидит новый ключ.
